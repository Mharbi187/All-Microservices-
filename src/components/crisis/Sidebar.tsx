            ...
            <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
                ...
                <div style={{ padding: '16px 24px', flex: 1, overflowY: 'auto' }}>
                    ...
                    <Menu
                        ...
                        mode="inline"
                        selectedKeys={[panel]}
                        onClick={({ key }) => setPanel(key as CommandCenterPanel)}
                        style={{
                        ...
                        items={[
                            ...
                            { key: 'incidents', icon: <FileTextOutlined />, label: `Incident Log (${incidentCount})` },
                            { key: 'responders', icon: <TeamOutlined />, label: `Responders (${responderCount})` },
                        ]}
                    />
                </div>
