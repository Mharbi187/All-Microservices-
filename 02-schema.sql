...
-- BCrypt: $2a$10$QjyxeErTap9SLvWhvHiRKuuv.KcZtFM7riUZ1taZHeZCFZwFQ22Qy
-- =============================================================================
...
CREATE TABLE committee_roles (
    id               UUID         DEFAULT gen_random_uuid() PRIMARY KEY,
    role_def_id      UUID         NOT NULL REFERENCES role_definitions(id),
...
('00000000-0000-0000-0000-000000000001', 'superadmin@crt.tn',   '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'WebMaster Support', '00000001', '+21671000001', 'ADMIN', 'APPROVED'),
('00000000-0000-0000-0000-000000000002', 'admin.si@crt.tn',     '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Responsable SI',    '00000002', '+21671000002', 'ADMIN', 'APPROVED');
...
('10000000-0000-0000-0000-000000000001', 'president.national@crt.tn',     '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Ahmed Ben Salah',    '09876543', '+21671320001', 'VOLUNTEER', 'APPROVED', '1968-05-12'),
('10000000-0000-0000-0000-000000000002', 'vp.national@crt.tn',            '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Fatma Khelifi',      '09876544', '+21671320002', 'VOLUNTEER', 'APPROVED', '1972-09-25'),
('10000000-0000-0000-0000-000000000003', 'sg.national@crt.tn',            '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Karim Trabelsi',     '09876545', '+21671320003', 'VOLUNTEER', 'APPROVED', '1975-03-07'),
('10000000-0000-0000-0000-000000000004', 'resp.secourisme.nat@crt.tn',    '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Sami Bouaziz',       '09876546', '+21698111001', 'VOLUNTEER', 'APPROVED', '1980-11-18'),
('10000000-0000-0000-0000-000000000005', 'resp.sante.nat@crt.tn',         '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Dr. Ines Mansouri',  '09876547', '+21622111002', 'VOLUNTEER', 'APPROVED', '1978-07-30'),
('10000000-0000-0000-0000-000000000006', 'resp.jeunesse.nat@crt.tn',      '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Mohamed Larbi',      '09876548', '+21655111003', 'VOLUNTEER', 'APPROVED', '1985-02-14'),
('10000000-0000-0000-0000-000000000007', 'resp.diffusion.nat@crt.tn',     '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Anis Gharbi',        '09876549', '+21650111004', 'VOLUNTEER', 'APPROVED', '1983-06-21'),
('10000000-0000-0000-0000-000000000008', 'resp.social.nat@crt.tn',        '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Leila Zaki',         '09876550', '+21625111005', 'VOLUNTEER', 'APPROVED', '1979-08-03'),
('10000000-0000-0000-0000-000000000009', 'resp.vff.nat@crt.tn',           '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Rima Saafi',         '09876551', '+21629111006', 'VOLUNTEER', 'APPROVED', '1982-12-05'),
('10000000-0000-0000-0000-000000000010', 'resp.immigration.nat@crt.tn',   '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Omar Cherni',        '09876552', '+21654111007', 'VOLUNTEER', 'APPROVED', '1977-04-17'),
('10000000-0000-0000-0000-000000000011', 'resp.catastrophe.nat@crt.tn',   '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Hichem Jebali',      '09876553', '+21652111008', 'VOLUNTEER', 'APPROVED', '1973-10-29');

-- ─── 4.4 USERS — Regional & Local ──────────────────────────────────────────
INSERT INTO users (id, email, password, full_name, cin, phone, user_type, account_status, birth_date) VALUES
('20000000-0000-0000-0000-000000000001', 'president.tunis@crt.tn',       '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Walid Hamdi',         '08500001', '+21671501001', 'VOLUNTEER', 'APPROVED', '1975-04-15'),
('20000000-0000-0000-0000-000000000002', 'sg.tunis@crt.tn',              '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Salma Ben Amor',      '08500002', '+21671501002', 'VOLUNTEER', 'APPROVED', '1980-09-22'),
('20000000-0000-0000-0000-000000000003', 'resp.sante.tunis@crt.tn',      '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Dr. Mehdi Tlili',     '08500003', '+21622501003', 'VOLUNTEER', 'APPROVED', '1978-01-08'),
('20000000-0000-0000-0000-000000000004', 'resp.secours.tunis@crt.tn',    '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Fadhel Gaddour',      '08500004', '+21698501004', 'VOLUNTEER', 'APPROVED', '1982-07-19'),
('20000000-0000-0000-0000-000000000005', 'resp.jeunesse.tunis@crt.tn',   '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Sana Riahi',          '08500005', '+21655501005', 'VOLUNTEER', 'APPROVED', '1990-03-30'),
('20000000-0000-0000-0000-000000000006', 'resp.social.tunis@crt.tn',     '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Hajer Boulares',      '08500006', '+21629501006', 'VOLUNTEER', 'APPROVED', '1985-11-14'),
('20000000-0000-0000-0000-000000000007', 'resp.vff.tunis@crt.tn',        '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Amira Baccar',        '08500007', '+21654501007', 'VOLUNTEER', 'APPROVED', '1983-06-02'),
('20000000-0000-0000-0000-000000000010', 'president.sousse@crt.tn',      '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Nabil Ferchichi',     '08600001', '+21673601001', 'VOLUNTEER', 'APPROVED', '1972-08-11'),
('20000000-0000-0000-0000-000000000011', 'sg.sousse@crt.tn',             '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Yomna Chabaane',      '08600002', '+21673601002', 'VOLUNTEER', 'APPROVED', '1979-02-27'),
('20000000-0000-0000-0000-000000000012', 'resp.secours.sousse@crt.tn',   '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Imed Chekir',         '08600003', '+21698601003', 'VOLUNTEER', 'APPROVED', '1985-05-15'),
('20000000-0000-0000-0000-000000000013', 'resp.immigration.sousse@crt.tn','$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Chiraz Selmi',        '08600004', '+21652601004', 'VOLUNTEER', 'APPROVED', '1988-09-09'),
('20000000-0000-0000-0000-000000000020', 'president.sfax@crt.tn',        '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Bassem Dridi',        '08700001', '+21674701001', 'VOLUNTEER', 'APPROVED', '1970-12-03'),
('20000000-0000-0000-0000-000000000021', 'sg.sfax@crt.tn',               '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Olfa Abid',           '08700002', '+21674701002', 'VOLUNTEER', 'APPROVED', '1977-07-16'),
('20000000-0000-0000-0000-000000000022', 'resp.sante.sfax@crt.tn',       '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Dr. Asma Hamdouni',   '08700003', '+21625701003', 'VOLUNTEER', 'APPROVED', '1981-04-22'),
('20000000-0000-0000-0000-000000000030', 'president.bizerte@crt.tn',     '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Sofien Baraket',      '08800001', '+21672801001', 'VOLUNTEER', 'APPROVED', '1974-03-28'),
('20000000-0000-0000-0000-000000000031', 'sg.bizerte@crt.tn',            '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Intissar Ayari',      '08800002', '+21672801002', 'VOLUNTEER', 'APPROVED', '1980-10-05'),
('20000000-0000-0000-0000-000000000040', 'president.nabeul@crt.tn',      '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Tarek Ben Youssef',   '08900001', '+21672901001', 'VOLUNTEER', 'APPROVED', '1976-06-14'),
('20000000-0000-0000-0000-000000000041', 'sg.nabeul@crt.tn',             '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Najwa Khalfoun',      '08900002', '+21672901002', 'VOLUNTEER', 'APPROVED', '1983-01-31'),
('20000000-0000-0000-0000-000000000050', 'president.kairouan@crt.tn',    '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Abdelaziz Snoussi',   '09000001', '+21677001001', 'VOLUNTEER', 'APPROVED', '1968-11-25'),
('30000000-0000-0000-0000-000000000001', 'president.bardo@crt.tn',       '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Mohsen Barhoumi',     '07100001', '+21671100001', 'VOLUNTEER', 'APPROVED', '1981-03-10'),
('30000000-0000-0000-0000-000000000002', 'sg.bardo@crt.tn',              '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Aymen Mahjoubi',      '07100002', '+21671100002', 'VOLUNTEER', 'APPROVED', '1987-07-20'),
('30000000-0000-0000-0000-000000000003', 'president.ariana@crt.tn',      '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Noura Hamrouni',      '07200001', '+21671200001', 'VOLUNTEER', 'APPROVED', '1984-11-05'),
('30000000-0000-0000-0000-000000000004', 'sg.ariana@crt.tn',             '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Fares Jlassi',        '07200002', '+21671200002', 'VOLUNTEER', 'APPROVED', '1990-04-18');

-- ─── 4.5 USERS — Classic Volunteers (PENDING/REJECTED edge cases) ───────────
INSERT INTO users (id, email, password, full_name, cin, phone, user_type, account_status, birth_date) VALUES
('40000000-0000-0000-0000-000000000001', 'secouriste1@crt.tn',    '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Ali Sghaier',         '05100001', '+21698201001', 'VOLUNTEER', 'APPROVED', '1992-04-10'),
('40000000-0000-0000-0000-000000000002', 'medecin1@crt.tn',       '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Dr. Manel Hadj Tahar','05100002', '+21622202002', 'VOLUNTEER', 'APPROVED', '1988-11-23'),
('40000000-0000-0000-0000-000000000003', 'logisticien1@crt.tn',   '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Mehdi Chebbi',        '05100003', '+21699203003', 'VOLUNTEER', 'APPROVED', '1990-07-15'),
('40000000-0000-0000-0000-000000000004', 'it1@crt.tn',            '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Hamza Agrebi',        '05100004', '+21625204004', 'VOLUNTEER', 'APPROVED', '1995-02-28'),
('40000000-0000-0000-0000-000000000005', 'communic1@crt.tn',      '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Yasmine Fersi',       '05100005', '+21650205005', 'VOLUNTEER', 'APPROVED', '1993-09-03'),
('40000000-0000-0000-0000-000000000070', 'PENDING1@crt.tn',       '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Yassine Ben Salem',   '05200001', '+21698300001', 'VOLUNTEER', 'PENDING',  '1998-06-15'),
('40000000-0000-0000-0000-000000000071', 'PENDING2@crt.tn',       '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Olfa Rezgui',         '05200002', '+21655300002', 'VOLUNTEER', 'PENDING',  '2000-01-20'),
('40000000-0000-0000-0000-000000000080', 'rejected1@crt.tn',      '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Nihel Farhat',        '05300001', '+21698400001', 'VOLUNTEER', 'REJECTED', '1996-03-10'),
('40000000-0000-0000-0000-000000000090', 'suspended1@crt.tn',     '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Hatem Krichen',       '05400001', '+21698500001', 'VOLUNTEER', 'SUSPENDED','1985-08-22');

-- ─── 4.6 USERS — Donors ────────────────────────────────────────────────────
INSERT INTO users (id, email, password, full_name, cin, phone, user_type, account_status) VALUES
('50000000-0000-0000-0000-000000000001', 'donateur1@gmail.com',   '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Groupe Poulina SA',   '06100001', '+21671600001', 'DONOR', 'APPROVED'),
('50000000-0000-0000-0000-000000000002', 'donateur2@banque.tn',   '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Banque Zitouna',      '06100002', '+21671600002', 'DONOR', 'APPROVED'),
('50000000-0000-0000-0000-000000000003', 'donateur3@yahoo.fr',    '$2a$10$X345NjupDkGkPNf5XfnLkOJOy/vq62F5nToZjjBzs5jyD354Rn8jG', 'Hamid Ben Fredj',     '06100003', '+21698600003', 'DONOR', 'APPROVED');
...
INSERT INTO committee_roles (id, role_def_id, committee_id, volunteer_id, status, approved_by, approved_at, assigned_at, mandate_end_date) VALUES
('c3000001-0000-0000-0000-000000000001','c1000001-0000-0000-0000-000000000001','a0000000-0000-0000-0000-000000000001','10000000-0000-0000-0000-000000000001','APPROVED','00000000-0000-0000-0000-000000000001','2024-01-15','2024-01-15','2028-01-15'),
('c3000001-0000-0000-0000-000000000002','c1000001-0000-0000-0000-000000000002','a0000000-0000-0000-0000-000000000001','10000000-0000-0000-0000-000000000002','APPROVED','00000000-0000-0000-0000-000000000001','2024-01-15','2024-01-15','2028-01-15'),
('c3000001-0000-0000-0000-000000000003','c1000001-0000-0000-0000-000000000003','a0000000-0000-0000-0000-000000000001','10000000-0000-0000-0000-000000000003','APPROVED','00000000-0000-0000-0000-000000000001','2024-01-15','2024-01-15','2028-01-15'),
('c3000001-0000-0000-0000-000000000004','c1000001-0000-0000-0000-000000000004','a0000000-0000-0000-0000-000000000001','10000000-0000-0000-0000-000000000004','APPROVED','10000000-0000-0000-0000-000000000001','2024-01-16','2024-01-16','2028-01-15'),
('c3000001-0000-0000-0000-000000000005','c1000001-0000-0000-0000-000000000005','a0000000-0000-0000-0000-000000000001','10000000-0000-0000-0000-000000000005','APPROVED','10000000-0000-0000-0000-000000000001','2024-01-16','2024-01-16','2028-01-15'),
('c3000001-0000-0000-0000-000000000006','c1000001-0000-0000-0000-000000000006','a0000000-0000-0000-0000-000000000001','10000000-0000-0000-0000-000000000006','APPROVED','10000000-0000-0000-0000-000000000001','2024-01-16','2024-01-16','2028-01-15'),
('c3000001-0000-0000-0000-000000000007','c1000001-0000-0000-0000-000000000007','a0000000-0000-0000-0000-000000000001','10000000-0000-0000-0000-000000000007','APPROVED','10000000-0000-0000-0000-000000000001','2024-01-16','2024-01-16','2028-01-15'),
('c3000001-0000-0000-0000-000000000008','c1000001-0000-0000-0000-000000000008','a0000000-0000-0000-0000-000000000001','10000000-0000-0000-0000-000000000008','APPROVED','10000000-0000-0000-0000-000000000001','2024-01-16','2024-01-16','2028-01-15'),
('c3000001-0000-0000-0000-000000000009','c1000001-0000-0000-0000-000000000009','a0000000-0000-0000-0000-000000000001','10000000-0000-0000-0000-000000000009','APPROVED','10000000-0000-0000-0000-000000000001','2024-01-16','2024-01-16','2028-01-15'),
('c3000001-0000-0000-0000-000000000010','c1000001-0000-0000-0000-000000000010','a0000000-0000-0000-0000-000000000001','10000000-0000-0000-0000-000000000010','APPROVED','10000000-0000-0000-0000-000000000001','2024-01-16','2024-01-16','2028-01-15'),
('c3000001-0000-0000-0000-000000000011','c1000001-0000-0000-0000-000000000011','a0000000-0000-0000-0000-000000000001','10000000-0000-0000-0000-000000000011','APPROVED','10000000-0000-0000-0000-000000000001','2024-01-16','2024-01-16','2028-01-15'),
('c3000002-0000-0000-0000-000000000001','c1000001-0000-0000-0000-000000000001','b0000000-0000-0000-0000-000000000001','20000000-0000-0000-0000-000000000001','APPROVED','10000000-0000-0000-0000-000000000001','2025-01-10','2025-01-10','2029-01-10'),
('c3000002-0000-0000-0000-000000000002','c1000001-0000-0000-0000-000000000003','b0000000-0000-0000-0000-000000000001','20000000-0000-0000-0000-000000000002','APPROVED','10000000-0000-0000-0000-000000000001','2025-01-10','2025-01-10','2029-01-10'),
('c3000002-0000-0000-0000-000000000003','c1000001-0000-0000-0000-000000000005','b0000000-0000-0000-0000-000000000001','20000000-0000-0000-0000-000000000003','APPROVED','20000000-0000-0000-0000-000000000001','2025-01-11','2025-01-11','2029-01-10'),
('c3000002-0000-0000-0000-000000000004','c1000001-0000-0000-0000-000000000004','b0000000-0000-0000-0000-000000000001','20000000-0000-0000-0000-000000000004','APPROVED','20000000-0000-0000-0000-000000000001','2025-01-11','2025-01-11','2029-01-10'),
('c3000002-0000-0000-0000-000000000005','c1000001-0000-0000-0000-000000000006','b0000000-0000-0000-0000-000000000001','20000000-0000-0000-0000-000000000005','APPROVED','20000000-0000-0000-0000-000000000001','2025-01-11','2025-01-11','2029-01-10'),
('c3000002-0000-0000-0000-000000000006','c1000001-0000-0000-0000-000000000008','b0000000-0000-0000-0000-000000000001','20000000-0000-0000-0000-000000000006','APPROVED','20000000-0000-0000-0000-000000000001','2025-01-11','2025-01-11','2029-01-10'),
('c3000002-0000-0000-0000-000000000007','c1000001-0000-0000-0000-000000000009','b0000000-0000-0000-0000-000000000001','20000000-0000-0000-0000-000000000007','APPROVED','20000000-0000-0000-0000-000000000001','2025-01-11','2025-01-11','2029-01-10'),
('c3000003-0000-0000-0000-000000000001','c1000001-0000-0000-0000-000000000001','b0000000-0000-0000-0000-000000000002','20000000-0000-0000-0000-000000000010','APPROVED','10000000-0000-0000-0000-000000000001','2025-03-01','2025-03-01','2029-03-01'),
('c3000003-0000-0000-0000-000000000002','c1000001-0000-0000-0000-000000000003','b0000000-0000-0000-0000-000000000002','20000000-0000-0000-0000-000000000011','APPROVED','10000000-0000-0000-0000-000000000001','2025-03-01','2025-03-01','2029-03-01'),
('c3000003-0000-0000-0000-000000000003','c1000001-0000-0000-0000-000000000004','b0000000-0000-0000-0000-000000000002','20000000-0000-0000-0000-000000000012','APPROVED','20000000-0000-0000-0000-000000000010','2025-03-02','2025-03-02','2029-03-01'),
('c3000003-0000-0000-0000-000000000004','c1000001-0000-0000-0000-000000000010','b0000000-0000-0000-0000-000000000002','20000000-0000-0000-0000-000000000013','APPROVED','20000000-0000-0000-0000-000000000010','2025-03-02','2025-03-02','2029-03-01'),
('c3000004-0000-0000-0000-000000000001','c1000001-0000-0000-0000-000000000001','b0000000-0000-0000-0000-000000000003','20000000-0000-0000-0000-000000000020','APPROVED','10000000-0000-0000-0000-000000000001','2025-05-01','2025-05-01','2029-05-01'),
('c3000004-0000-0000-0000-000000000002','c1000001-0000-0000-0000-000000000003','b0000000-0000-0000-0000-000000000003','20000000-0000-0000-0000-000000000021','APPROVED','10000000-0000-0000-0000-000000000001','2025-05-01','2025-05-01','2029-05-01'),
('c3000004-0000-0000-0000-000000000003','c1000001-0000-0000-0000-000000000005','b0000000-0000-0000-0000-000000000003','20000000-0000-0000-0000-000000000022','APPROVED','20000000-0000-0000-0000-000000000020','2025-05-02','2025-05-02','2029-05-01'),
('c3000005-0000-0000-0000-000000000001','c1000001-0000-0000-0000-000000000001','c0000000-0000-0000-0000-000000000001','30000000-0000-0000-0000-000000000001','APPROVED','20000000-0000-0000-0000-000000000001','2023-06-01','2023-06-01','2027-06-01'),
('c3000005-0000-0000-0000-000000000002','c1000001-0000-0000-0000-000000000003','c0000000-0000-0000-0000-000000000001','30000000-0000-0000-0000-000000000002','APPROVED','20000000-0000-0000-0000-000000000001','2023-06-01','2023-06-01','2027-06-01'),
('c3000005-0000-0000-0000-000000000003','c1000001-0000-0000-0000-000000000004','c0000000-0000-0000-0000-000000000001','40000000-0000-0000-0000-000000000001','APPROVED','30000000-0000-0000-0000-000000000001','2023-06-02','2023-06-02','2027-06-01'),
('c3000005-0000-0000-0000-000000000004','c1000001-0000-0000-0000-000000000009','c0000000-0000-0000-0000-000000000001','30000000-0000-0000-0000-000000000002','APPROVED','30000000-0000-0000-0000-000000000001','2023-06-02','2023-06-02','2027-06-01'),
('c3000005-0000-0000-0000-000000000005','c1000001-0000-0000-0000-000000000010','c0000000-0000-0000-0000-000000000001','30000000-0000-0000-0000-000000000001','APPROVED','30000000-0000-0000-0000-000000000001','2023-06-02','2023-06-02','2027-06-01'),
('c3000005-0000-0000-0000-000000000006','c1000001-0000-0000-0000-000000000011','c0000000-0000-0000-0000-000000000001','40000000-0000-0000-0000-000000000001','APPROVED','30000000-0000-0000-0000-000000000001','2023-06-02','2023-06-02','2027-06-01'),
('c3000006-0000-0000-0000-000000000001','c1000001-0000-0000-0000-000000000001','c0000000-0000-0000-0000-000000000002','30000000-0000-0000-0000-000000000003','APPROVED','20000000-0000-0000-0000-000000000001','2023-02-01','2023-02-01','2027-02-01'),
('c3000006-0000-0000-0000-000000000002','c1000001-0000-0000-0000-000000000003','c0000000-0000-0000-0000-000000000002','30000000-0000-0000-0000-000000000004','APPROVED','20000000-0000-0000-0000-000000000001','2023-02-01','2023-02-01','2027-02-01');
