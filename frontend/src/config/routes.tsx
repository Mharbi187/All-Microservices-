...
// ---- Auth Guard: redirect to /login if not authenticated; redirect to /onboarding if profile not completed ----
...
const SecurityDashboardPage = lazy(() => import('@/pages/settings/SecurityDashboardPage'));
...
export const router = createBrowserRouter([
    ...
    // ---- App Routes (protected, with sidebar + header) ----
    {
        ...
        children: [
            ...
            // Security
            { path: 'security', element: withLoader(<SecurityDashboardPage />) },
        ],
    },
    ...
    // ---- Onboarding Route (fullscreen, no sidebar, requires auth) ----
    {
        path: '/onboarding',
        element: withLoader(<OnboardingPage />),
    },
